...
const URL = {
    ...
    "LIST": "?project=%s&status=all&perpage=%s",
    "RSS": `rss.php?proj=%s`,
...
var TaskProvider = function (baseUrl) {
    ...
    self.list = (projectId, limit = 200) => {
        ...
        console.log(self.forgeUrl(URL.LIST, projectId, limit));
        var options = {
            url: self.forgeUrl(URL.LIST, projectId, limit),
            headers: {
                'User-Agent': 'ovh-task-broadcast-kikoo-IAAS'
            },
            json: true
